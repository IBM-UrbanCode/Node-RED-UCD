# IBM UrbanCode Deploy Node-RED Plugin
---
...
### Compatibility
	The IBM UrbanCode Deploy automation plugin installs and supports Node-RED.
...
### Installation
	...
	manual build step. Otherwise, download the entire Node-RED-UCD and 
...
3. The built plugin is located at releases/Node-RED-UCD-vdev.zip 
